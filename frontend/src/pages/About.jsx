...
const About = () => {
  const galleryImages = [
    ...
    <div className="w-[300px] md:w-[500px] aspect-video overflow-hidden grayscale hover:grayscale-0 transition-all duration-500">
  ...
  return (
    <PageTransition>
      <div className="w-full pt-32 md:pt-40 px-6 md:px-20 bg-white min-h-screen">
        ...
        <div className="mb-20 md:mb-40">
          ...
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-extrabold tracking-tighter text-blend leading-[0.9]">
            ...
            <span className="text-blend-light">
                <RevealText text="ARTISANS" delay={0.3} />
            </span>
          </h1>

          <div className="mt-16 md:mt-32 grid grid-cols-1 md:grid-cols-12 gap-10">
            <div className="md:col-span-6 md:col-start-7">
               <motion.p 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5, duration: 0.8 }}
                className="text-xl md:text-3xl font-medium leading-relaxed text-blend-dark"
               >
        ...
        {/* --- GALLERY MARQUEE --- */}
        <section className="py-20 -mx-6 md:-mx-20 overflow-hidden">
        ...
        {/* --- TEAM --- */}
        <section className="py-20 md:py-40 bg-blend text-white -mx-6 md:-mx-20 px-6 md:px-20">
