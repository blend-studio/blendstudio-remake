    ...
    <PageTransition>
      <div className="w-full overflow-hidden bg-white">
        ...
        >
           ...
           <div className="px-6 md:px-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 relative z-10">
              {servicesShort.map((service, i) => (
                <motion.div 
                  ...
                  whileHover={{ y: -15 }}
                  className="group relative p-10 bg-white border border-gray-100 hover:border-blend-light/30 hover:shadow-[0_30px_60px_-15px_rgba(47,101,128,0.15)] transition-all duration-700 rounded-[2.5rem] overflow-hidden"
                >
                   {/* Background Number */}
        ...
        <section className="py-32 md:py-48 bg-white overflow-hidden relative group/slider-section">
            ...
            <div className="max-w-[110rem] mx-auto px-6 md:px-10 lg:px-20 relative">
                ...
                <div className="absolute top-[40%] left-0 xl:-left-12 z-30 pointer-events-none w-full xl:w-[calc(100%+6rem)] hidden lg:flex justify-between px-4 xl:px-0">
                    <button 
                      onClick={() => scroll('left')}
